...
# Equipment per room
ROOM_EQUIPMENT = {
    '406-3':   ['โปรเจกเตอร์', 'สมาร์ทบอร์ด', 'ระบบเสียง', 'แอร์', 'Wi-Fi',],
    '406-5':   ['โทรทัศน์(ใหญ่)','โทรทัศน์(เล็ก)', 'แอร์', 'Wi-Fi'],
    '408-1':   ['โทรทัศน์(เล็ก)', 'สมาร์ทไวท์บอร์ด', 'แอร์', 'Wi-Fi'],
...
def login_view(request):
    ...
    bookable_room_count = Room.objects.filter(is_active=True).count()
    ...
    return render(request, 'accounts/login.html', {
        'error': error,
        'next': next_url,
        'bookable_room_count': bookable_room_count,
    })
...
def floor_map(request):
    ...
    ROOM_POSITIONS = {
        '406':   (70.7, 84.4), '406-1': (61.3, 85.2), '406-2': (54.4, 85.2),
        '406-3': (59.4, 77.4), '406-4': (73.7, 77.4),
        '406-5': (73.8, 66.8), '406-6': (65.0, 66.5), '406-7': (55.8, 66.5),
        '407':   (42.4, 85.4), '408':   (40.4, 82.4),
        '408-1': (38.9, 78.2), '408-2': (26.0, 78.2), '408-3': (13.7, 78.2),
        '408-2/1': (23.8, 78.2), '408-2/2': (29.4, 78.2),
        '408-4': (20.0, 86.3), '408-5': (27.3, 86.3), '408-6': (34.9, 86.3),
        '409':   (31.5, 68.5),
        '410':   (26.0, 55.3), '410-1': (39.8, 50.4), '410-2': (27.9, 50.4), '410-3': (14.5, 50.4),
        '410-4': (14.5, 59.7), '410-5': (27.3, 59.7), '410-6': (35.7, 59.7),
        '411':   (25.6, 40.8),
        '411-1': (39.7, 45.9), '411-2': (27.6, 45.9), '411-3': (15.3, 45.9),
        '411-4': (13.8, 35.8), '411-5': (24.4, 35.8), '411-6': (34.6, 35.8),
        '412':   (24.3, 24.8),
        '412-1': (34.2, 15.6), '412-2': (27.1, 15.6), '412-3': (20.4, 15.6), '412-4': (12.8, 15.6),
        '412-5': (12.8, 20.3), '412-6': (12.8, 25.2), '412-7': (12.8, 30.2),
        '412-8': (34.6, 30.1), '412-9': (34.6, 25.8),
        '416':   (42.0, 28.3),
        '418':   (65.6, 28.6),
        '418-1': (58.1, 32.3), '418-2': (71.4, 32.3),
        '418-3': (89.7, 30.8), '418-4': (89.7, 25.8), '418-5': (89.7, 20.8),
        '418-6': (88.2, 16.2), '418-7': (81.4, 16.2), '418-8': (74.8, 16.2), '418-9': (68.2, 16.2),
        '418-10':(69.4, 24.5), '418-11':(76.2, 24.5),
        '420':   (72.2, 38.8), '421':   (65.0, 48.4), '422':   (65.0, 58.3),
        '422-1': (58.5, 62.5), '422-2': (72.2, 62.5),
        '422-3': (72.5, 54.8), '422-4': (61.9, 54.8),
    }
    rooms = Room.objects.filter(is_active=True).order_by('code')
