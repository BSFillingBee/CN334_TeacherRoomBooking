...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-+=6y=ovchl&^-!_8c&o1e92zp6q*iex-w6wnpc#ng%ftoz4o4d')
...
AUTHENTICATION_BACKENDS = [
    'accounts.auth_backend.TUAuthenticationBackend',
...
# Email Settings (Using Gmail as requested in SRS)
...
DEFAULT_FROM_EMAIL = f"Room Booking System <{EMAIL_HOST_USER}>"
...
MOCK_API = env_bool('MOCK_API', True)
